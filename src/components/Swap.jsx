    ...
    <div className='swapBox'>
        ...
        <div className='swapHolder'>
            ...
            <div className="swapbox_select">
                <input className="form-control" type='number' placeholder="amount" id="from_amount" onChange={()=>getPrice()}/>
            </div>
        </div>
        ...
        {/*<button disabled className='swapButton' id='swap_button'></button>*/}
    </div>
